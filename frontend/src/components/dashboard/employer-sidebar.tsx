...
import { EMPLOYER_NAV } from "@/config/employer-nav";
  ...
  return (
    ...
    >
      <div className="border-b border-border px-4 py-4">
        ...
        <p className="mt-0.5 text-xs text-muted">Employer workspace</p>
      </div>
      <nav className="flex-1 overflow-y-auto px-3 py-4">
        <DashboardNavGroups groups={EMPLOYER_NAV} onNavigate={onNavigate} />
      </nav>
    </aside>
  );
}
