...
export default function SponsoredJobsPage() {
  ...
  const checkout = useMutation({
    mutationFn: () =>
      createCheckout({ purpose: "SPONSORED_JOB", provider: "mock" }),
    onSuccess: (res) => {
    ...
    <div className="space-y-8">
      <div className="mx-auto max-w-3xl rounded-xl border border-border bg-card p-4">
        <p className="text-sm text-muted">
          Sponsored (urgent) publish may require a SPONSORED_JOB purchase.
        </p>
